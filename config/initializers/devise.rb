...
Devise.setup do |config|
  ...
  config.mailer_sender = "Friendiose-Notification@friendiose.com"

  # Configure the class responsible to send e-mails.
  # config.mailer = "Devise::Mailer"

  Devise::Mailer.layout "mail_layout" # email.haml or email.erb
  ...
  # config.pepper = "6186b4a136e9a5aef3152cfdd74ed6433ce03712d84c9dbfed905f1d6ada9a592112555946e6c0ad64a6703d3d6e6f14be35c8d6452802d4fdf51d91c34766b1"
  ...
  config.omniauth :facebook, ENV['FR_FACEBOOK_KEY'], ENV['FR_FACEBOOK_SECRET'], :scope => 'email,user_birthday,publish_actions'
